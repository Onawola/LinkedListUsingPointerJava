...
public class List implements ListJava {
    Component front, last;
    ...
    @Override
    public int locateObj(Object obj) {
        int position = 0;
    ...
    @Override
    public boolean enlistObj(Object obj, int position) {
        if (position == 1) {
